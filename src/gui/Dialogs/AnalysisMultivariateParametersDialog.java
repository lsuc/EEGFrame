 ...
 *
 */
public class AnalysisMultivariateParametersDialog extends JDialog {
	...
	private ExtractMultivariateFeaturesWindow window;
	
	public AnalysisMultivariateParametersDialog(ExtractMultivariateFeaturesWindow window){
	...
	public void saveInterval(ExtractMultivariateFeaturesController multivariateController){
