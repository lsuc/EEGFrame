 ...
 */
package features.nonlinear.phaseSpace;

/**
 * @author Jovic
 *
 * @version Ovaj razred sadrži tzv. "Takensove parametre" (iako kao takvi oni ne postoje)
 * nužne za atraktor. Nužni su za definiranje atraktora: rekonstrukcijska dimenzija, 
...
public class ParametersTakens {
	...
	/**
	 * Defaultni konstruktor sadrži defaultne postavke za dimenziju, duljinu serije, interval T i 
	 * poèetnu toèku.
	 */
